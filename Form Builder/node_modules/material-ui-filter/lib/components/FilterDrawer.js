...
var filterActions = _interopRequireWildcard(_actions);
...
var _OperatorField = require("./OperatorField");

var _OperatorField2 = _interopRequireDefault(_OperatorField);
...
var _SortByAlpha = require("@material-ui/icons/SortByAlpha");
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_SortByAlpha2.default, null)
              )
            )
          ),
          ...
          _react2.default.createElement(
            ...
            queries.map(function (query, i) {
              ...
              return _react2.default.createElement(
                ...
                _react2.default.createElement(_OperatorField2.default, {
                  queryIndex: i,
                  currentField: field,
                  query: query,
                  fields: fields,
                ...
                _react2.default.createElement(_SearchField.SearchField, {
                  id: "searchField",
                  queryIndex: i,
                  currentField: field,
                  query: query,
...
FilterDrawer.propTypes = process.env.NODE_ENV !== "production" ? {
  formatMessage: _propTypes2.default.func,
  theme: _propTypes2.default.object.isRequired,
  name: _propTypes2.default.string.isRequired,
  fields: _propTypes2.default.array.isRequired,
  setFilterIsOpen: _propTypes2.default.func.isRequired
} : {};
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var allOperators = [{
    value: "like",
    label: formatMessage ? formatMessage({ id: "operator_like_label" }) : "Like"
  }, {
    value: "notlike",
    label: formatMessage ? formatMessage({ id: "operator_notlike_label" }) : "Not like"
  }, {
    value: "=",
    label: formatMessage ? formatMessage({ id: "operator_equal_label" }) : "="
  }, {
    value: "!=",
    label: formatMessage ? formatMessage({ id: "operator_notequal_label" }) : "!="
  }, { value: ">", label: ">" }, { value: ">=", label: ">=" }, { value: "<", label: "<" }, { value: "<=", label: "<=" }, {
    value: "novalue",
    label: formatMessage ? formatMessage({ id: "operator_novalue_label" }) : "No value"
  }, {
    value: "contains",
    label: formatMessage ? formatMessage({ id: "operator_contains_label" }) : "Contains"
  }];
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, _extends({}, filterActions))((0, _styles.withStyles)(styles, { withTheme: true })(FilterDrawer));
